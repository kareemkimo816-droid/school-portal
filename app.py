...
if stage != "Choose Grade / اختر المرحلة":
    ...
    try:
        # الرابط ده بيسحب أول 500 سطر غصب عن أي كاش
        url = f"https://docs.google.com/spreadsheets/d/{sheet_id}/gviz/tq?tqx=out:csv&sheet={stage}&range=A1:E500&v={random.randint(1,999999)}"
        
        df = pd.read_csv(url, dtype=str)

        # تنظيف: حذف الصفوف الفاضية تماماً في عمود المادة
        ...
        st.error("Error! تأكد من تحديث الشيت.")
