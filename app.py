...
if stage != "Choose Grade / اختر المرحلة":
    ...
    try:
        # السر هنا: استخدام رابط التصدير الخام (export?format=csv)
        # ده بيجبر جوجل يبعت "كل" الصفحة كملف واحد مش مجرد معاينة
        ...
        st.error(f"Error! لم نتمكن من الوصول لتبويب '{stage}'.")
